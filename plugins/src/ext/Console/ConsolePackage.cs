...
namespace Org.OpenEngSB.Loom.Csharp.VisualStudio.Plugins.Console
{
    ...
    [Guid(GuidList.guidConsolePkgString)]
    public sealed class ConsolePackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidConsoleCmdSet, (int)PkgCmdIDList.cmdOpenConsole);
